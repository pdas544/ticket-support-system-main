...
if (! is_file($tmpFile) || ! is_readable($tmpFile)) {
    file_put_contents(__DIR__ . '/../logs/send_error.log', "Missing or unreadable file: $tmpFile\n", FILE_APPEND);
    exit(1);
}
...
if (! $data) {
    file_put_contents(__DIR__ . '/../logs/send_error.log', "Invalid JSON in file: $tmpFile\n", FILE_APPEND);
    exit(1);
}
